...
while ($zeile = $projini->fetch_array()) {
    ...
    $all =  $mysqli->query("SELECT * FROM ta WHERE imei= '$puser'  AND  send_email_stat = '1' ORDER BY time DESC LIMIT 1 ;");    
    while ($row1 = $all->fetch_array()) {
      ...
      //  echo $count . ' = ' .  $puser .' = ' .$ID. ' = ' . $em1 . ' = ' .$imei1 . '<br>';
        ...
        $latest =  $mysqli->query("SELECT * FROM ta  WHERE imei = '$puser'  AND  send_email_stat = '0' ORDER BY ID DESC LIMIT 1 ;");
        while ($row2 =  $latest->fetch_array()) {
           ...
           // echo "*".$count . ' = ' .  $puser .' = '  .$ID2. ' = '. $em2 . ' = '.$imei2  . ' = ' . $DX2 .' = '  . '<br>';
            echo $count . ' = ' .  $puser .' = ' .$ID. ' = ' . $em1 . ' = ' .$imei1 . ' = '. $DX1 . ' = ' .  ' = ' . '   : '.  date('j.n.Y.', $dattime1) . ' um ' . date('H:i:s', $dattime1) .'   ***  ' .$ID2. ' = '. $em2 . ' = '.$imei2  . ' = ' . $DX2 .' = '  . '<br>';
                ...
                if ($in === 1) {
                    ...
                    while ($rowr = $result->fetch_array()) {
                        if (!empty($rowr['EMAIL'])) {
                            ...
                            $message .= "</div>" . "</div>";
                            $not_sendemail = array( "357796103360634", "359315076932911", "359315076849305", "359315076932945", "359315076995918", "359315076927846", "359315076932788", "359315076930998" , "357796103360675");
                           echo $message;
