...
$projekte = $mysqli->query("SELECT * FROM bfprojekt WHERE AKTIV = '1';");
while($zeile = $projekte->fetch_array())
{
  ...
  while($zeile2 = $projektini->fetch_array())
  {
    ...
    echo   	$puser.  ' , '.$DxALERT[1]. ' , '.$DxALERT1[1]. ' <br>';
  }
  ...
  {   
    ...
    echo "<td>" .$puser ."</td>";
    echo "<td>  " .$TWad .$TWnr ."." .$TWnoe ."</td>";
    echo "<td>  " .intval($aktiv); 
    echo intval($bftimeout);
    echo intval($bferr) ."</td>";  
    echo "<td> " .$bferr ."</td>";  
    echo "<td> D:" .$bfDerr;  
    echo " A1:" .$bfA1err;  
    echo " A2:" .$bfA2err ."</td>";  
  ...
  // Abspeichern
  // $insert = "INSERT INTO stat_test (ID, PUSER, ERROR, TIMEOUT, LASTDATA, AKTIV, DERR, A1ERR, A2ERR, TIME) VALUES";
